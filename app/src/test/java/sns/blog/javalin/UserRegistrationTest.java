...
public class UserRegistrationTest {
  ...
  /**
   * Sending an http request to POST localhost:8080/register when username does not exist in the
   * system
   *
   * <p>Expected Response: Status Code: 200 Response Body: JSON representation of user object
   */
  @Test
  ...
  /**
   * Sending an http request to POST localhost:8080/register when no password is less than 4
   * characters
   *
   * <p>Expected Response: Status Code: 400 Response Body:
   */
