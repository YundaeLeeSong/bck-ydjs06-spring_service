...
public class RetrieveAllMessagesTest {
   ...
   *
   * <p>Expected Response: Status Code: 200 Response Body: JSON represenation of a list of message
   * objects
   */
  @Test
  public void getAllMessagesMessagesAvailable() throws IOException, InterruptedException {
    HttpRequest request =
        HttpRequest.newBuilder().uri(URI.create("http://localhost:8080/messages")).build();
   ...
   *
   * <p>Expected Response: Status Code: 200 Response Body: JSON represenation of an empty list
   */
  @Test
